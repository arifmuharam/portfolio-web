const data = [
  {
    id: 1,
    imageProject: "/assets/images/menit-project.png",
    imageLogo: "/assets/images/menit-logo.svg",
    title: "Menit",
    label: [
  ...
  {
    id: 2,
    imageProject: "/assets/images/bookshelf-project.png",
    imageLogo: "/assets/images/bookshelf-logo.svg",
    title: "Bookshelf",
    label: [
      { id: 1, name: "HTML", className: "html" },
  ...
  {
    id: 3,
    imageProject: "/assets/images/ecocycle-project.png",
    imageLogo: "/assets/images/ecocycle-logo.svg",
    title: "EcoCycle",
    label: [
